...
/* Uncomment the line below according to the target STM32 device used in your
   application 
 * Розкоментуйте лінію нижче відповідно до цільового пристрою STM32, що використовується у вашої
   розробці
  */
 ...
 *	Порада. Щоб уникнути зміни цього файлу кожного разу,коли вам слід  переключатися
	між цими пристроїв, ви можете визначити пристрій у препроцесорі компілятора інструментального ланцюга.
 */
 ...
 * Користуйтесь (не розкоментовуйте) лінією нижче, якщо ви не будете використовувати
   драйвери периферійних пристроїв. У цьому випадку ці драйвери не будуть включені 
   і код програми буде базуватися на прямому доступі до регістрів периферійних пристроїв
*/
  /*#define USE_STDPERIPH_DRIVER */
 ...
 * На наступній позиції коригуйте значення зовнішнього високошвидкісного осцилятора (HSE),
   що використовується у вашій розробці
   Tip: To avoid modifying this file each time you need to use different HSE, you
        can define the HSE value in your toolchain compiler preprocessor.
   Порада: Щоб уникнути модифікації цього файлу кожного разу, коли вам потрібно використовувати іншу HSE, ви
        може визначити значення HSE у препроцесоре компілятора toolchain.
  */           
 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
   Timeout value 
 * На наступній лінії відрегулюйте запуск зовнішнього високошвидкісного осцилятора (HSE)
 ...
 *		  Визначення номера переривань STM32F4XX відповідно до вибраного пристрою
 *		  в @ref Library_configuration_section
 */
typedef enum IRQn
{
